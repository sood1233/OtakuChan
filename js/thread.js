  ...
  wrap.innerHTML = `
    <div class="pc" id="op-post">
      ...
      <div class="acts">
        ...
        <span class="ai"><span class="ic">&#128172;</span> ${replies.length} repl${replies.length === 1 ? 'y' : 'ies'}</span>
        <span class="ai flag" onclick="openReport('${p.id}')">&#9873; Report thread</span>
      </div>
    </div>
...
function replyHtml(r) {
  ...
  <div class="rc" id="reply-${r.id}">
    <div class="ph">
      ...
      <span class="views" title="${r.view_count || 0} views">&#128065; ${fmtCount(r.view_count)}</span>
      <span class="ai flag" style="float:right;" onclick="openReport('${postId}','${r.id}')">&#9873; Report</span>
    </div>
